...
## Project Structure
    ...
    ├── testapiautocatalog_109118  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_109118`
...
2. Clone this repo and `cd testapiautocatalog_109118`
